...
3. **预设风格模式**：
   - **干净模式**：主风格 1.15 / 上色 0.8 / 线条 0.35 / 光影 0.4。附加词：`clean lineart, delicate lineart, soft coloring, medium complexity, simple background`。
   - **浓郁模式**：主风格 1.45 / 上色 1.0 / 线条 0.55 / 光影 0.7。附加词：`high complexity, depthness, detailed background, rich colors, dramatic lighting`。
   - **保守测试模式**：主风格 1.0 / 上色 0.6 / 线条 0.2 / 光影 0.25。附加词：`clean lineart, soft coloring, simple background`。
